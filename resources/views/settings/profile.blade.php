...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex items-center gap-1 bg-gray-100 dark:bg-surface-800 rounded-xl p-1 mb-8 w-fit">
        <a href="{{ route('settings.profile') }}" class="px-4 py-2 text-sm font-medium rounded-lg bg-white dark:bg-surface-700 text-gray-900 dark:text-white shadow-sm">Profile</a>
        <a href="{{ route('settings.tokens') }}" class="px-4 py-2 text-sm font-medium rounded-lg text-gray-500 hover:text-gray-700 dark:hover:text-gray-300">API Tokens</a>
    </div>
            ...
            <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-surface-800 rounded-xl">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">{{ $google ? 'Connected' : 'Not connected' }}</p>
                    </div>
                </div>
                @if(!$google)
                    <a href="{{ route('social.redirect', 'google') }}" class="px-3 py-1.5 text-xs font-medium bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors">Connect</a>
                @endif
            </div>
            <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-surface-800 rounded-xl">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500">{{ $github ? 'Connected' : 'Not connected' }}</p>
                    </div>
                </div>
                @if(!$github)
                    <a href="{{ route('social.redirect', 'github') }}" class="px-3 py-1.5 text-xs font-medium bg-gray-800 dark:bg-gray-700 text-white rounded-lg hover:bg-gray-900 dark:hover:bg-gray-600 transition-colors">Connect</a>
                @endif
            </div>
        </div>
    </div>
