...
<head>
    ...
    <title>{{ $title ?? 'Dashboard' }} - BrainVault</title>
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="hidden lg:flex lg:flex-col w-64 bg-white dark:bg-surface-900 border-r border-gray-200 dark:border-gray-800 fixed inset-y-0 left-0 z-30"
            ...
            <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                ...
                <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-surface-800 transition-colors">
