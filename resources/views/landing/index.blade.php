...
<body class="bg-white dark:bg-surface-950 font-sans antialiased overflow-x-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center gap-8">
                    <a href="#features" class="text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">{{ __('Features') }}</a>
            ...
            <div x-show="mobileMenu" x-transition class="md:hidden py-4 border-t border-gray-200 dark:border-gray-800">
                <div class="space-y-2">
                    <a href="#features" class="block px-3 py-2 text-sm font-medium text-gray-600 dark:text-gray-400 rounded-lg hover:bg-gray-100 dark:hover:bg-surface-800">{{ __('Features') }}</a>
        ...
        <div class="relative max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <h1 class="text-5xl lg:text-7xl font-extrabold tracking-tight text-gray-900 dark:text-white">
                    {{ __('Your') }} <span class="text-gradient">{{ __('Second Brain') }}</span><br>{{ __('for the Web') }}
                </h1>
                <p class="mt-6 text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
                    {{ __('Save bookmarks, highlight text, take notes, and let AI organize your knowledge. One platform for everything you read, learn, and discover online.') }}
                </p>
                ...
                <p class="mt-4 text-sm text-gray-500">{{ __('Free forever. No credit card required.') }}</p>
            </div>
    ...
    <section id="features" class="py-20 lg:py-32 bg-surface-50 dark:bg-surface-900/50">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center max-w-2xl mx-auto mb-16">
                <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white">{{ __('Everything you need to') }}<br><span class="text-gradient">{{ __('capture knowledge') }}</span></h2>
                <p class="mt-4 text-lg text-gray-600 dark:text-gray-400">{{ __('From quick saves to deep research, BrainVault handles it all.') }}</p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white dark:bg-surface-900 rounded-2xl p-8 border border-gray-200 dark:border-gray-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">{{ __('One-Click Bookmarks') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">{{ __('Save any page with one click. Auto-captures title, description, screenshots, and metadata.') }}</p>
                </div>
                ...
                <div class="bg-white dark:bg-surface-900 rounded-2xl p-8 border border-gray-200 dark:border-gray-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">{{ __('Web Highlighting') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">{{ __('Highlight text directly on any website. Annotations sync to your dashboard automatically.') }}</p>
                </div>
                ...
                <div class="bg-white dark:bg-surface-900 rounded-2xl p-8 border border-gray-200 dark:border-gray-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">{{ __('Smart Notes') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">{{ __('Rich text editor for notes with auto-linking to bookmarks, highlights, and topics.') }}</p>
                </div>
                ...
                <div class="bg-white dark:bg-surface-900 rounded-2xl p-8 border border-gray-200 dark:border-gray-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">{{ __('AI Summaries') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">{{ __('Auto-generate summaries, extract keywords, and categorize content with GPT-4.') }}</p>
                </div>
                ...
                <div class="bg-white dark:bg-surface-900 rounded-2xl p-8 border border-gray-200 dark:border-gray-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">{{ __('Powerful Search') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">{{ __('Full-text search across all your bookmarks, notes, highlights, and AI summaries.') }}</p>
                </div>
                ...
                <div class="bg-white dark:bg-surface-900 rounded-2xl p-8 border border-gray-200 dark:border-gray-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">{{ __('Team Collaboration') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">{{ __('Share collections, bookmark together, and build a team knowledge base.') }}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="how-it-works" class="py-20 lg:py-32">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center max-w-2xl mx-auto mb-16">
                <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white">{{ __('How it works') }}</h2>
                <p class="mt-4 text-lg text-gray-600 dark:text-gray-400">{{ __('Three simple steps to organize your online knowledge.') }}</p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('Install Extension') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400">{{ __('Add the BrainVault Chrome extension to your browser in one click.') }}</p>
                </div>
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('Save & Highlight') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400">{{ __('Bookmark pages, highlight text, and add notes while you browse.') }}</p>
                </div>
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('Let AI Organize') }}</h3>
                    <p class="text-gray-600 dark:text-gray-400">{{ __('AI auto-categorizes, summarizes, and connects your knowledge.') }}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="pricing" class="py-20 lg:py-32 bg-surface-50 dark:bg-surface-900/50">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center max-w-2xl mx-auto mb-16">
                <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white">{{ __('Simple, transparent pricing') }}</h2>
                <p class="mt-4 text-lg text-gray-600 dark:text-gray-400">{{ __('Start free, upgrade when you need more power.') }}</p>
            </div>

            <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                {{-- Free Plan --}}
                <div class="bg-white dark:bg-surface-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-8">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white">{{ __('Free') }}</h3>
                    <p class="mt-2 text-sm text-gray-500">{{ __('For getting started') }}</p>
                    <div class="mt-6">
                        <span class="text-4xl font-extrabold text-gray-900 dark:text-white">$0</span>
                        <span class="text-gray-500">/month</span>
                    </div>
                    <ul class="mt-8 space-y-3">
                        <li class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"><svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg> {{ __('100 bookmarks') }}</li>
                        <li class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"><svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg> {{ __('50 notes') }}</li>
                        <li class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"><svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg> {{ __('Chrome extension') }}</li>
                        <li class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"><svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg> {{ __('Basic search') }}</li>
                    </ul>
                    <a href="{{ route('register') }}" class="mt-8 block w-full text-center px-4 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold rounded-xl hover:bg-gray-50 dark:hover:bg-surface-800 transition-colors">{{ __('Get Started') }}</a>
                </div>

                {{-- Pro Plan --}}
                <div class="bg-white dark:bg-surface-900 rounded-2xl border-2 border-primary-500 p-8 relative shadow-xl">
                    <div class="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-primary-500 text-white text-xs font-bold rounded-full">{{ __('Popular') }}</div>
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white">{{ __('Pro') }}</h3>
                    <p class="mt-2 text-sm text-gray-500">{{ __('For power users') }}</p>
                    <div class="mt-6">
                        <span class="text-4xl font-extrabold text-gray-900 dark:text-white">$8</span>
                        <span class="text-gray-500">/month</span>
                    </div>
                    <ul class="mt-8 space-y-3">
                        <li class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"><svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg> {{ __('Unlimited bookmarks') }}</li>
                        <li class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"><svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg> {{ __('Unlimited notes') }}</li>
                        <li class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"><svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg> {{ __('AI summaries & keywords') }}</li>
                        <li class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"><svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg> {{ __('Knowledge graph') }}</li>
                        <li class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"><svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg> {{ __('Priority support') }}</li>
                    </ul>
                    <a href="{{ route('register') }}" class="mt-8 block w-full text-center px-4 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-xl shadow-lg shadow-primary-500/25 transition-all">{{ __('Get Pro') }}</a>
                </div>

                {{-- Team Plan --}}
                <div class="bg-white dark:bg-surface-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-8">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white">{{ __('Team') }}</h3>
                    <p class="mt-2 text-sm text-gray-500">{{ __('For teams and orgs') }}</p>
                    <div class="mt-6">
                        <span class="text-4xl font-extrabold text-gray-900 dark:text-white">$15</span>
                        <span class="text-gray-500">/user/month</span>
                    </div>
                    <ul class="mt-8 space-y-3">
                        <li class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"><svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg> {{ __('Everything in Pro') }}</li>
                        <li class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"><svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg> {{ __('Shared collections') }}</li>
                        <li class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"><svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg> {{ __('Team knowledge base') }}</li>
                        <li class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"><svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg> {{ __('Admin dashboard') }}</li>
                        <li class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"><svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" /></svg> {{ __('SSO & audit log') }}</li>
                    </ul>
                    <a href="{{ route('register') }}" class="mt-8 block w-full text-center px-4 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold rounded-xl hover:bg-gray-50 dark:hover:bg-surface-800 transition-colors">{{ __('Start Trial') }}</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 lg:py-32">
        <div class="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            <h2 class="text-3xl lg:text-5xl font-bold text-gray-900 dark:text-white">{{ __('Ready to build your') }}<br><span class="text-gradient">{{ __('second brain') }}</span>?</h2>
            <p class="mt-6 text-lg text-gray-600 dark:text-gray-400 max-w-xl mx-auto">{{ __('Join thousands of knowledge workers who use BrainVault to save, organize, and rediscover information.') }}</p>
            <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="{{ route('register') }}" class="w-full sm:w-auto px-8 py-4 btn-gradient font-semibold rounded-2xl transition-all text-lg">
                    {{ __('Get Started Free') }}
                </a>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="grid md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-sm text-gray-500">{{ __('Your second brain for the web. Save, organize, and rediscover.') }}</p>
                </div>
                <div>
                    <h4 class="font-semibold text-gray-900 dark:text-white mb-4">{{ __('Product') }}</h4>
                ...
                <div>
                    <h4 class="font-semibold text-gray-900 dark:text-white mb-4">{{ __('Legal') }}</h4>
                    <ul class="space-y-2 text-sm text-gray-500">
                        <li><a href="#" class="hover:text-gray-700 dark:hover:text-gray-300">{{ __('Privacy Policy') }}</a></li>
                        <li><a href="#" class="hover:text-gray-700 dark:hover:text-gray-300">{{ __('Terms of Service') }}</a></li>
                        <li><a href="#" class="hover:text-gray-700 dark:hover:text-gray-300">{{ __('Cookie Policy') }}</a></li>
                    </ul>
                </div>
            </div>
