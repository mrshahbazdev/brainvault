<x-layouts.auth title="Sign In">
    <div>
        ...
        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">{{ __('Sign in to your BrainVault account') }}</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5" x-data="{ showPassword: false }">
        ...
        <div>
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('password.request') }}" class="text-sm font-medium text-primary-600 hover:text-primary-500">{{ __('Forgot password?') }}</a>
            </div>
        ...
        <div class="flex items-center">
            ...
            <label for="remember" class="ml-2 text-sm text-gray-600 dark:text-gray-400">{{ __('Remember me for 30 days') }}</label>
        </div>
    ...
    <p class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
        ...
        <a href="{{ route('register') }}" class="font-semibold text-primary-600 hover:text-primary-500">{{ __('Create one free') }}</a>
    </p>
</x-layouts.auth>
