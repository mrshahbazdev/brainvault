<x-layouts.auth title="Forgot Password">
    <div>
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Forgot your password?') }}</h2>
        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">{{ __("No worries. Enter your email and we'll send you a reset link.") }}</p>
    </div>
    ...
    <p class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
        ...
        <a href="{{ route('login') }}" class="font-semibold text-primary-600 hover:text-primary-500">{{ __('Back to sign in') }}</a>
    </p>
</x-layouts.auth>
