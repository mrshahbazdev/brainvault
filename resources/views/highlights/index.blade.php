...
<div>
    ...
    <div class="bg-white dark:bg-surface-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-8">
        <div class="text-center py-12">
            ...
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ __('Start Highlighting') }}</h2>
            <p class="text-sm text-gray-500 max-w-md mx-auto mb-6">{{ __('Install the BrainVault Chrome extension to highlight text on any webpage. Your highlights will appear here automatically.') }}</p>
