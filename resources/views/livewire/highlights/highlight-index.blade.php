<div>
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6">
        <div class="relative flex-1 w-full">
            ...
            <input wire:model.live.debounce.300ms="search" type="text" placeholder="Search highlights..."
        ...
        <div class="flex items-center gap-1 bg-gray-100 dark:bg-surface-800 rounded-xl p-1">
            ...
            @foreach(['#FBBF24' => 'Yellow', '#22C55E' => 'Green', '#3B82F6' => 'Blue', '#EC4899' => 'Pink', '#8B5CF6' => 'Purple'] as $hex => $name)
                ...
                <div class="p-5">
                    ...
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
                            <button wire:click="deleteHighlight({{ $highlight->id }})" wire:confirm="Delete this highlight?"
        ...
        @empty
            <div class="bg-white dark:bg-surface-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-8">
                <div class="text-center py-12">
                    ...
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">No highlights yet</h2>
                    <p class="text-sm text-gray-500 max-w-md mx-auto mb-6">Use the BrainVault Chrome extension to highlight text on any webpage. Your highlights will appear here automatically.</p>
                </div>
            </div>
        @endforelse
    </div>
